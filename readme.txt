...
= 2.4.6 - Nov 23, 2022 =
* Fix: Adjust navigation opacity, apply to all pages. To disable it by single page, it is recommended to use a classname that is generated in body.

= 2.4.5 - Nov 22, 2022 =
* Enhance: remove navbar opacity if template has no header.

= 2.4.4 - Nov 3, 2022 =
* Fix: css style of navbar with modal behavior.

= 2.4.3 - Nov 3, 2022 =
* Checkup: compatibility WordPress 6.1.

= 2.4.2 - Oct 15, 2022 =
* Improve: New navbar view option (customizer).
* Improve: Refactor js code in the main navbar theme.
* Improve: remove old js.
* Update Bootstrap library to stable version (5.2.2).
...
* Fix: WP6 changes the_excerpt() method, this setting allows the view of autogenerated content, in listings (blog,home,archive) (theme-elements.php).
* Related: https://wordpress.org/search/the_excerpt()/.
