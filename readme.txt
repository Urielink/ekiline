...
* Fix: WP6 changes the_excerpt() method, this setting allows the view of autogenerated content, in listings (blog,home,archive).
pendiente : http://localhost/wpdev/ekiline/2021/02/23/entrada-que-ocupa-bloque-con-thumbnail/
El bloque tiene un loop infinito, que da error, solo al ocupar el extracto.
