...
function construirCssGeneral(){
	...
	cssall += '.table-primary{--bs-table-bg:var(--bs-primary-table-bg);--bs-table-striped-bg:var(--bs-primary-table-striped-bg);--bs-table-striped-color:rgb(var(--bs-black-rgb));--bs-table-active-bg:var(--bs-primary-table-active-bg);--bs-table-active-color:rgb(var(--bs-black-rgb));--bs-table-hover-bg:var(--bs-primary-table-hover-bg);--bs-table-hover-color:rgb(var(--bs-black-rgb));color:rgb(var(--bs-black-rgb));border-color:var(--bs-primary-table-active-bg);}\n';
	cssall += '.table-secondary{--bs-table-bg:var(--bs-secondary-table-bg);--bs-table-striped-bg:var(--bs-secondary-table-striped-bg);--bs-table-striped-color:rgb(var(--bs-black-rgb));--bs-table-active-bg:var(--bs-secondary-table-active-bg);--bs-table-active-color:rgb(var(--bs-black-rgb));--bs-table-hover-bg:var(--bs-secondary-table-hover-bg);--bs-table-hover-color:rgb(var(--bs-black-rgb));color:rgb(var(--bs-black-rgb));border-color:var(--bs-secondary-table-active-bg);}\n';
	cssall += '.table-success{--bs-table-bg:var(--bs-success-table-bg);--bs-table-striped-bg:var(--bs-success-table-striped-bg);--bs-table-striped-color:rgb(var(--bs-black-rgb));--bs-table-active-bg:var(--bs-success-table-active-bg);--bs-table-active-color:rgb(var(--bs-black-rgb));--bs-table-hover-bg:var(--bs-success-table-hover-bg);--bs-table-hover-color:rgb(var(--bs-black-rgb));color:rgb(var(--bs-black-rgb));border-color:var(--bs-success-table-active-bg);}\n';
	cssall += '.table-info{--bs-table-bg:var(--bs-info-table-bg);--bs-table-striped-bg:var(--bs-info-table-striped-bg);--bs-table-striped-color:rgb(var(--bs-black-rgb));--bs-table-active-bg:var(--bs-info-table-active-bg);--bs-table-active-color:rgb(var(--bs-black-rgb));--bs-table-hover-bg:var(--bs-info-table-hover-bg);--bs-table-hover-color:rgb(var(--bs-black-rgb));color:rgb(var(--bs-black-rgb));border-color:var(--bs-info-table-active-bg);}\n';
	cssall += '.table-warning{--bs-table-bg:var(--bs-warning-table-bg);--bs-table-striped-bg:var(--bs-warning-table-striped-bg);--bs-table-striped-color:rgb(var(--bs-black-rgb));--bs-table-active-bg:var(--bs-warning-table-active-bg);--bs-table-active-color:rgb(var(--bs-black-rgb));--bs-table-hover-bg:var(--bs-warning-table-hover-bg);--bs-table-hover-color:rgb(var(--bs-black-rgb));color:rgb(var(--bs-black-rgb));border-color:var(--bs-warning-table-active-bg);}\n';
	cssall += '.table-danger{--bs-table-bg:var(--bs-danger-table-bg);--bs-table-striped-bg:var(--bs-danger-table-striped-bg);--bs-table-striped-color:rgb(var(--bs-black-rgb));--bs-table-active-bg:var(--bs-danger-table-active-bg);--bs-table-active-color:rgb(var(--bs-black-rgb));--bs-table-hover-bg:var(--bs-danger-table-hover-bg);--bs-table-hover-color:rgb(var(--bs-black-rgb));color:rgb(var(--bs-black-rgb));border-color:var(--bs-danger-table-active-bg);}\n';
	cssall += '.table-light{--bs-table-bg:var(--bs-light);--bs-table-striped-bg:var(--bs-light-table-striped-bg);--bs-table-striped-color:rgb(var(--bs-black-rgb));--bs-table-active-bg:var(--bs-light-table-active-bg);--bs-table-active-color:rgb(var(--bs-black-rgb));--bs-table-hover-bg:var(--bs-light-table-hover-bg);--bs-table-hover-color:rgb(var(--bs-black-rgb));color:rgb(var(--bs-black-rgb));border-color:var(--bs-light-table-active-bg);}\n';
	cssall += '.table-dark{--bs-table-bg:var(--bs-dark);--bs-table-striped-bg:var(--bs-dark-table-striped-bg);--bs-table-striped-color:rgb(var(--bs-black-rgb));--bs-table-active-bg:var(--bs-dark-table-active-bg);--bs-table-active-color:rgb(var(--bs-black-rgb));--bs-table-hover-bg:var(--bs-dark-table-hover-bg);--bs-table-hover-color:rgb(var(--bs-black-rgb));color:rgb(var(--bs-white-rgb));border-color:var(--bs-dark-table-active-bg);}\n';
	/**Formularios**/
	...
	cssall += '.btn-info{color:rgb(var(--bs-black-rgb));background-color:var(--bs-info);border-color:var(--bs-info);}\n';
	cssall += '.btn-info:hover{color:rgb(var(--bs-black-rgb));background-color:var(--bs-info-btn-hover);border-color:var(--bs-info-btn-active);}\n';
	cssall += '.btn-check:focus+.btn-info,.btn-info:focus{color:rgb(var(--bs-black-rgb));background-color:var(--bs-info-btn-hover);border-color:var(--bs-info-btn-active);box-shadow:0 0 0 0.25rem rgba(var(--bs-info-rgb),0.5);}\n';
	cssall += '.btn-check:checked+.btn-info,.btn-check:active+.btn-info,.btn-info:active,.btn-info.active,.show>.btn-info.dropdown-toggle{color:rgb(var(--bs-black-rgb));background-color:var(--bs-info-link-hover);border-color:var(--bs-info-btn-active);}\n';
	...
	cssall += '.btn-info:disabled,.btn-info.disabled{color:rgb(var(--bs-black-rgb));background-color:var(--bs-info);border-color:var(--bs-info);}\n';
	cssall += '.btn-warning{color:rgb(var(--bs-black-rgb));background-color:var(--bs-warning);border-color:var(--bs-warning);}\n';
	cssall += '.btn-warning:hover{color:rgb(var(--bs-black-rgb));background-color:var(--bs-warning-btn-hover);border-color:var(--bs-warning-btn-active);}\n';
	cssall += '.btn-check:focus+.btn-warning,.btn-warning:focus{color:rgb(var(--bs-black-rgb));background-color:var(--bs-warning-btn-hover);border-color:var(--bs-warning-btn-active);box-shadow:0 0 0 0.25rem rgba(var(--bs-warning-rgb),0.5);}\n';
	cssall += '.btn-check:checked+.btn-warning,.btn-check:active+.btn-warning,.btn-warning:active,.btn-warning.active,.show>.btn-warning.dropdown-toggle{color:rgb(var(--bs-black-rgb));background-color:var(--bs-warning-link-hover);border-color:var(--bs-warning-btn-active);}\n';
	...
	cssall += '.btn-warning:disabled,.btn-warning.disabled{color:rgb(var(--bs-black-rgb));background-color:var(--bs-warning);border-color:var(--bs-warning);}\n';
	...
	cssall += '.btn-light{color:rgb(var(--bs-black-rgb));background-color:var(--bs-light);border-color:var(--bs-light);}\n';
	cssall += '.btn-light:hover{color:rgb(var(--bs-black-rgb));background-color:var(--bs-light-btn-hover);border-color:var(--bs-light-btn-active);}\n';
	cssall += '.btn-check:focus+.btn-light,.btn-light:focus{color:rgb(var(--bs-black-rgb));background-color:var(--bs-light-btn-hover);border-color:var(--bs-light-btn-active);box-shadow:0 0 0 0.25rem rgba(var(--bs-light-rgb),0.5);}\n';
	cssall += '.btn-check:checked+.btn-light,.btn-check:active+.btn-light,.btn-light:active,.btn-light.active,.show>.btn-light.dropdown-toggle{color:rgb(var(--bs-black-rgb));background-color:var(--bs-light-link-hover);border-color:var(--bs-light-btn-active);}\n';
	...
	cssall += '.btn-light:disabled,.btn-light.disabled{color:rgb(var(--bs-black-rgb));background-color:var(--bs-light);border-color:var(--bs-light);}\n';
	cssall += '.btn-dark{color:rgb(var(--bs-white-rgb));background-color:var(--bs-dark);border-color:var(--bs-dark);}\n';
	cssall += '.btn-dark:hover{color:rgb(var(--bs-white-rgb));background-color:var(--bs-dark-btn-hover);border-color:var(--bs-dark-btn-active);}\n';
	cssall += '.btn-check:focus+.btn-dark,.btn-dark:focus{color:rgb(var(--bs-black-rgb));background-color:var(--bs-dark-btn-hover);border-color:var(--bs-dark-btn-active);box-shadow:0 0 0 0.25rem rgba(var(--bs-dark-rgb),0.5);}\n';
	cssall += '.btn-check:checked+.btn-dark,.btn-check:active+.btn-dark,.btn-dark:active,.btn-dark.active,.show>.btn-dark.dropdown-toggle{color:rgb(var(--bs-black-rgb));background-color:var(--bs-dark-link-hover);border-color:var(--bs-dark-btn-active);}\n';
	...
	cssall += '.btn-dark:disabled,.btn-dark.disabled{color:rgb(var(--bs-black-rgb));background-color:var(--bs-dark);border-color:var(--bs-dark);}\n';
	...
	cssall += '.btn-outline-info:hover{color:rgb(var(--bs-black-rgb));background-color:var(--bs-info);border-color:var(--bs-info);}\n';
	cssall += '.btn-check:focus+.btn-outline-info,.btn-outline-info:focus{box-shadow:0 0 0 0.25rem rgba(var(--bs-info-rgb),0.5);}\n';
	cssall += '.btn-check:checked+.btn-outline-info,.btn-check:active+.btn-outline-info,.btn-outline-info:active,.btn-outline-info.active,.btn-outline-info.dropdown-toggle.show{color:rgb(var(--bs-black-rgb));background-color:var(--bs-info);border-color:var(--bs-info);}\n';
	...
	cssall += '.btn-outline-warning:hover{color:rgb(var(--bs-black-rgb));background-color:var(--bs-warning);border-color:var(--bs-warning);}\n';
	...
	cssall += '.btn-check:checked+.btn-outline-warning,.btn-check:active+.btn-outline-warning,.btn-outline-warning:active,.btn-outline-warning.active,.btn-outline-warning.dropdown-toggle.show{color:rgb(var(--bs-black-rgb));background-color:var(--bs-warning);border-color:var(--bs-warning);}\n';
	...
	cssall += '.btn-outline-light:hover{color:rgb(var(--bs-black-rgb));background-color:var(--bs-light);border-color:var(--bs-light);}\n';
	cssall += '.btn-check:focus+.btn-outline-light,.btn-outline-light:focus{box-shadow:0 0 0 0.25rem rgba(var(--bs-light-rgb),0.5);}\n';
	cssall += '.btn-check:checked+.btn-outline-light,.btn-check:active+.btn-outline-light,.btn-outline-light:active,.btn-outline-light.active,.btn-outline-light.dropdown-toggle.show{color:rgb(var(--bs-black-rgb));background-color:var(--bs-light);border-color:var(--bs-light);}\n';
	...
	cssall += '.btn-outline-dark:hover{color:rgb(var(--bs-black-rgb));background-color:var(--bs-dark);border-color:var(--bs-dark);}\n';
	cssall += '.btn-check:focus+.btn-outline-dark,.btn-outline-dark:focus{box-shadow:0 0 0 0.25rem rgba(var(--bs-dark-rgb),0.5);}\n';
	cssall += '.btn-check:checked+.btn-outline-dark,.btn-check:active+.btn-outline-dark,.btn-outline-dark:active,.btn-outline-dark.active,.btn-outline-dark.dropdown-toggle.show{color:rgb(var(--bs-black-rgb));background-color:var(--bs-dark);border-color:var(--bs-dark);}\n';
	...
	/**closeicon**/
	cssall += '.btn-close{color:rgb(var(--bs-black-rgb));}\n';
	cssall += '.btn-close:hover{color:rgb(var(--bs-black-rgb));}\n';
	...
	cssall += '.modal-backdrop{background-color:rgb(var(--bs-black-rgb));}\n';
	cssall += '.modal-header{border-bottom:1px solid var(--bs-gray-300);}\n';
	cssall += '.modal-footer{border-top:1px solid var(--bs-gray-300);}\n';
	/**tooltip**/
	cssall += '.bs-tooltip-top .tooltip-arrow::before,.bs-tooltip-auto[data-popper-placement^="top"] .tooltip-arrow::before{border-top-color:rgb(var(--bs-black-rgb));}\n';
	cssall += '.bs-tooltip-end .tooltip-arrow::before,.bs-tooltip-auto[data-popper-placement^="right"] .tooltip-arrow::before{border-right-color:rgb(var(--bs-black-rgb));}\n';
	cssall += '.bs-tooltip-bottom .tooltip-arrow::before,.bs-tooltip-auto[data-popper-placement^="bottom"] .tooltip-arrow::before{border-bottom-color:rgb(var(--bs-black-rgb));}\n';
	cssall += '.bs-tooltip-start .tooltip-arrow::before,.bs-tooltip-auto[data-popper-placement^="left"] .tooltip-arrow::before{border-left-color:rgb(var(--bs-black-rgb));}\n';
	cssall += '.tooltip-inner{color:var(--bs-white);background-color:rgb(var(--bs-black-rgb));}\n';
	/**popover**/
	...
	cssall += '.carousel-dark .carousel-indicators [data-bs-target]{background-color:rgb(var(--bs-black-rgb));}\n';
	cssall += '.carousel-dark .carousel-caption{color:rgb(var(--bs-black-rgb));}\n';
	cssall += '.offcanvas{background-color:var(--bs-white);}\n';
	cssall += '.offcanvas-backdrop{background-color:rgb(var(--bs-black-rgb));}\n';
	...
	cssall += '.placeholder-wave{-webkit-mask-image:linear-gradient(130deg,rgb(var(--bs-black-rgb)) 55%,rgba(var(--bs-black-rgb),0.8) 75%,rgb(var(--bs-black-rgb)) 95%);mask-image:linear-gradient(130deg,rgb(var(--bs-black-rgb)) 55%,rgba(var(--bs-black-rgb),0.8) 75%,rgb(var(--bs-black-rgb)) 95%);}\n';
